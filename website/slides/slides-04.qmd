...
::: notes
Prompt engineering is the art of getting LLMs to do what you want. 
:::
...
::: notes
First, let's see how well LLMs can interpret real data visualizations. Create a scatter plot and see what the model says.
:::
...
::: notes
Now let's explore hallucination. Show the model random noise and see if you can get it to admit there's no pattern - this demonstrates the importance of good prompting.
:::
...
::: notes
After those exercises, let's talk about prompt engineering best practices. When things don't work, ask yourself these three questions.
:::
...
::: notes
Finally, all the major providers have excellent documentation on prompt engineering. These are great resources to dive deeper.
:::
...
::: notes
Now put it all together - write a system prompt for a quiz game. This is a complex task that requires clear instructions and structure.
:::
