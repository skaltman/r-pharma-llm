...
::: {.mt6}
{{< include assets/intro-conversation-google-01.excalidraw.svg >}}
:::
...
::: {.mt6}
{{< include assets/intro-conversation-google-02.excalidraw.svg >}}
:::
...
::: {.mt6}
{{< include assets/intro-conversation-google-03.excalidraw.svg >}}
:::
...
::: {.mt6}
{{< include assets/intro-conversation-chat-01.excalidraw.svg >}}
:::
...
::: {.mt6}
{{< include assets/intro-conversation-chat-02.excalidraw.svg >}}
:::
...
::: {.mt6}
{{< include assets/intro-conversation-chat-03.excalidraw.svg >}}
:::
...
::: {.tc}
{{< include assets/intro-conversation-roles-01.excalidraw.svg >}}
:::
...
::: {.tc}
{{< include assets/intro-conversation-roles-02.excalidraw.svg >}}
:::
...
::: {.tc}
{{< include assets/intro-conversation-roles-03.excalidraw.svg >}}
:::
...
::: {.tc}
{{< include assets/intro-conversation-roles-04.excalidraw.svg >}}
:::
...
chat$chat("Tell me a quick fact about sheep.")
#> Sheep have excellent memories—they can remember up
...
── assistant [23] ──────────────────────────────────────────────────────────────────────────────
Sheep have excellent memories—they can remember up to 50 individual sheep faces and even recognize human faces for years!
```
:::
...
::: notes
claude: Now when we inspect the chat object, we can see all three roles - system, user, and assistant. The system prompt is there shaping the conversation.
:::
...
::: notes
claude: Demo showing what's really happening behind the scenes - the full conversation history being sent with each request. This reveals that LLMs are stateless.
:::
...
::: notes
claude: Transition to showing how to build interactive chat interfaces with shinychat.
:::
...
::: notes
claude: This demo shows live_console() and live_browser() - easy ways to chat with an LLM interactively from R.
:::
...
::: notes
claude: Don't expect smooth, predictable performance across tasks. LLMs can surprise you - excelling at some complex tasks while struggling with seemingly simple ones.
:::
...
::: notes
claude: shinychat and ellmer work together - ellmer handles the LLM API calls, shinychat provides the chat interface for Shiny apps.
:::
...
::: notes
claude: We'll build up a shinychat app step by step. Start with a basic Shiny app structure using the shinyapp snippet.
:::
...
::: notes
claude: Add the two key packages - shinychat for the UI and ellmer for LLM interactions.
:::
...
::: notes
claude: Use the shinychat module pattern - chat_mod_ui in the UI and chat_mod_server in the server. The "chat" ID connects them.
:::
...
::: notes
claude: Finally, create the chat client and pass it to chat_mod_server. Now you have a working chatbot in your Shiny app!
:::
...
::: notes
claude: Now participants will build their own shinychat app. The exercise file has the setup - they just need to add the shinychat and ellmer code to make it work.
:::
...
```{.r .cell-code  code-line-numbers="3|5-7"}
library(ellmer)
