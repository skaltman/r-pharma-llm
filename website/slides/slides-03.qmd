...
::: notes
OpenAI has GPT models in different sizes, Google has Gemini in different sizes - same pattern everywhere.
:::
...
::: notes
Here's a comparison table if you want to see the specific numbers for different models. But don't stress too much about this - pick something and try it.
:::
...
::: notes
See? It tells you which model it chose - Claude Sonnet 4.5.
:::
...
# Your Turn `04_models` {.slide-your-turn}
...
::: notes
These are the models I recommend using today. Nano and Haiku are fast, GPT-5 and Sonnet 4.5 are smarter. Pick based on what you're doing.
:::
...
## Your Turn `05_vision` {.slide-your-turn}

::: notes
Now try it yourself - use these food images to practice vision with LLMs. See what kind of descriptions they give.
:::

1. I've put some images of food in the `data/recipes/images` folder.

2. Your job: show the food to the LLM and ask it to write a corresponding recipe. 
...
::: notes
Practice with PDFs - convert these recipe PDFs to markdown. This shows how LLMs can extract and reformat document content.
:::
...
# Your Turn `06_structured-output` {.slide-your-turn}

::: notes
Now practice structured output - extract recipe data as proper R objects. This is a key skill for working with LLMs in real applications.
:::
